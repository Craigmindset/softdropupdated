...
function EnterBvn() {
  ...
  const canProceed = useMemo(() => bvn.length === 11, [bvn]);

  const onEnter = () => {
    if (!canProceed) return;
    router.push("/Carrier/ProfieScreen");
  };
  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      <View style={styles.container}>
        ...
        {/* Label */}
        <Text style={styles.label}>Please input your 11-digit NIN</Text>
        ...
        <Text style={styles.helper}>
          Your NIN will be used for identity validation.
        </Text>
